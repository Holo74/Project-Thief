...
namespace Player
{
    ...
    public partial class Variables
    {
        ...
        // public double SPEED_MAPPING = { STANDING_SPEED, () => { return CROUCH_SPEED; }, () => { return CRAWLING_SPEED; } };
        public double SPEED_MAPPING(int input)
        {
            switch (input)
            {
                case 0:
        ...
        #region   doubles
        public double GRAVITY_STRENGTH { get; set; } = 10f;
        public double JUMP_STRENGTH { get; set; } = 5f;
        public double STANDING_SPEED { get; set; } = 3.5f;
        public double BOOST_WALL_JUMP { get; set; } = .2f;
        public double SPRINT_SPEED { get; set; } = 1.5f;
        public double CROUCH_SPEED { get; set; } = 2.2f;
        public double CRAWLING_SPEED { get; set; } = 1f;
        public double MOVE_TO_CROUCH { get; set; } = 5f;
        public double MANTLE_FORWARD_SPEED { get; set; } = 6f;
        public double MANTLE_UPWARD_SPEED { get; set; } = 7.5f;
        public double MANTLE_UPWARD_TIME { get; set; } = 1f;
        public double MANTLE_FORWARD_TIME { get; set; } = 0.1f;
        public double MANTLE_BUFFER_TIMER { get; set; } = 0.1f;
        public double ACCELERATION { get; set; } = 10f;
        public double DECCELERATION { get; set; } = 10f;
        public double MAX_CAMERA_SHAKE { get; set; } = 0.4f;
        #endregion

        #region Modifiable doubles
        public double JUMP_MOD { get; set; } = 1f;
        public double SPEED_MOD { get; set; } = 1f;
        public double GRAVITY_MOD { get; set; } = 1f;
        public double CURRENT_SPEED { get; set; } = 0f;
        #endregion
