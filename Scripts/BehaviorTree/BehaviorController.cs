...
namespace BehaviorTree
{
    public class BehaviorController : Node
    {
        ...
        public Godot.Collections.Dictionary<string, object> BlackBoard { get; private set; }
        public override void _Ready()
        {
            BlackBoard = new Godot.Collections.Dictionary<string, object>();
        }
        ...
        public void InArea(Node body, bool entered, string name)
        {
